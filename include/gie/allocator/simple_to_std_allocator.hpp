...
namespace gie {
    ...
    struct simple_to_std_non_aligned_allocator_t<void,SimpleAllocatorT> {
        typedef std::size_t      size_type;
        typedef std::ptrdiff_t   difference_type;
        ...
        template <class U>
        simple_to_std_non_aligned_allocator_t(simple_to_std_non_aligned_allocator_t<U, SimpleAllocatorT> const& other)
                : simple_to_std_non_aligned_allocator_t(other.m_simple_allocator)
        {
        }
